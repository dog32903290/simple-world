...
#include "runtime/point_ops_timeclip.h"  // TimeClip: registerTimeClipOp (timeline-window scope around SubTree)
...
void registerDrawPointOps() {
  ...
  registerTimeClipOp();                          // Command → Command (timeline-window scope: [TimeRange) gate + TimeRange→SourceRange fx remap)
