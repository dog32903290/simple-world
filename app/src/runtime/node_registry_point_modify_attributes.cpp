...
static const PointModifyOp _reg_SetPointAttributes{
      {"SetPointAttributes",
       ...
       {{"points", "points", "Points", true},    // input bag (port 0)
        ...
        {"RotationAxis.y", "RotationAxis.y", "Float", true, 0.0f, -1.0f, 1.0f, Widget::Vec, {}, true, 1},
        {"RotationAxis.z", "RotationAxis.z", "Float", true, 1.0f, -1.0f, 1.0f, Widget::Vec, {}, true, 1},
        ...
        {"Fx1", "Fx1", "Float", true, 1.0f, 0.0f, 1.0f},
        {"SetFx2", "SetFx2", "Float", true, 0.0f, 0.0f, 1.0f, Widget::Bool, {}, true},
        {"Fx2", "Fx2", "Float", true, 1.0f, 0.0f, 1.0f},
