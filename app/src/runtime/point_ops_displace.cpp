...
// (displacechain golden stays in selftests.cpp kTable — one selftest per registrar.)
static const ImageFilterOp _reg_displace{
    ...
    {"Displace", "Displace",
     ...
     nullptr},
    "Displace", cookDisplace, "displace", runDisplaceSelfTest};
