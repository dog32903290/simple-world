...
static const PointModifyOp _reg_RandomizePoints{
      {"RandomizePoints",
       ...
       {{"points", "points", "Points", true},   // input bag (port 0)
        ...
        {"OffsetMode", "OffsetMode", "Float", true, 1.0f, 0.0f, 1.0f, Widget::Enum, {"Add", "Scatter"}},
        {"Space", "Space", "Float", true, 0.0f, 0.0f, 1.0f, Widget::Enum, {"Point", "Object"}},
        {"Interpolation", "Interpolation", "Float", true, 2.0f, 0.0f, 2.0f, Widget::Enum, {"None", "Linear", "Smooth"}},
        {"Repeat", "Repeat", "Float", true, 0.0f, 0.0f, 100000.0f},
        {"ClampColorsEtc", "ClampColorsEtc", "Float", true, 1.0f, 0.0f, 1.0f, Widget::Bool}},
       nullptr,
       "point.modify"}
};
