...
namespace sw { int runT3ChannelMixerParity(bool); }                  // t3import_blend_golden.cpp (★IMAGE-fx collapse GENERALIZES: MULTI-child Blend.t3 (6 helper value ops + fx-setup) through the SAME data-driven collapse → Normal-blend oracle (128,128,0,255); -bug drops ImageB → RED. Registered as "t3-channelmixer" for CLI slot stability; proves the collapse table is not HSE-only)
