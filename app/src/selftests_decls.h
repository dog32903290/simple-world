...
namespace sw { int runT3DepthToLinearGates(bool); }                  // t3import_depthtolinear_golden.cpp (★TEXTURE-COMPUTE SEAM stage 2: SRV-tex read + b0 CB. real _ComputeDepthToLinear.t3 (guid ade1d03d…) → collapseTextureComputeStageSrv folds the SRV/UAV/CB/size/sampler glue onto ONE ComputeShaderStageTex → resident cook (t3xf_depth_source fixture) + R32Float readback vs depth-linearization oracle. ①takeover(SRV wire + CB baked) ③reference ②parity ④layout under one -bug)
