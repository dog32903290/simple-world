/**
 * @file
 * my.numbers.vec2.vector2Components node implementation.
 *
 * TiXL parity contract:
 * - Visible title: my_Vector2Components
 * - Category: Operators/Lib/numbers/vec2
 * - Source: external/tixl/Operators/Lib/numbers/vec2/Vector2Components.cs
 * - Primary output(s): VuoReal X, VuoReal Y (ColorForValues #868C8D)
 *
...
VuoModuleMetadata({
					 "title" : "my_Vector2Components",
					 "description" : "TiXL Vector2Components exact vector adapter. Source: external/tixl/Operators/Lib/numbers/vec2/Vector2Components.cs. Category: Operators/Lib/numbers/vec2. Primary output(s): VuoReal X, VuoReal Y (ColorForValues #868C8D). ProofValue is Vuo-only.",
...
)
{
	...
	*x = input1.x; *y = input1.y; proof = fabs(*x) + fabs(*y);
	*proofValue = proof;
}
