/**
 * @file
 * my.numbers.anim.time.lastFrameDuration node implementation.
 *
 * TiXL parity contract:
 * - Visible title: my_LastFrameDuration
 * - Category: Operators/Lib/numbers/anim/time
 * - Source: external/tixl/Operators/Lib/numbers/anim/time/LastFrameDuration.cs
 * - Primary output(s): VuoReal Duration (ColorForValues #868C8D)
 *
 * bounded frame duration adapter. ProofValue is a Vuo-only numeric tap for the Batch 45 proof composition.
 */
...
VuoModuleMetadata({
					 "title" : "my_LastFrameDuration",
					 "description" : "TiXL LastFrameDuration bounded frame duration adapter. Source: external/tixl/Operators/Lib/numbers/anim/time/LastFrameDuration.cs. Category: Operators/Lib/numbers/anim/time. Primary output(s): VuoReal Duration (ColorForValues #868C8D). ProofValue is Vuo-only.",
