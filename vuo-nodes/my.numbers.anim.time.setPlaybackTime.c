/**
 * @file
 * my.numbers.anim.time.setPlaybackTime node implementation.
 *
 * TiXL parity contract:
 * - Visible title: my_SetPlaybackTime
 * - Category: Operators/Lib/numbers/anim/time
 * - Source: external/tixl/Operators/Lib/numbers/anim/time/SetPlaybackTime.cs
...
VuoModuleMetadata({
					 "title" : "my_SetPlaybackTime",
					 "description" : "TiXL SetPlaybackTime side-effect bounded adapter. Source: external/tixl/Operators/Lib/numbers/anim/time/SetPlaybackTime.cs. Category: Operators/Lib/numbers/anim/time. Primary output(s): VuoText CommandTrace (ColorForValues #868C8D). ProofValue is Vuo-only.",
...
)
{
	...
	*commandTrace = VuoText_make("SetPlaybackTime body-layer command trace"); proof = timeValue;
	*proofValue = proof;
}
