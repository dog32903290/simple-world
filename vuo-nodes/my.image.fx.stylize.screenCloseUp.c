/**
 * @file
 * my.image.fx.stylize.screenCloseUp node implementation.
 *
 * TiXL parity contract:
 * - Visible title: my_ScreenCloseUp
 * - Category: Operators/Lib/image/fx/stylize
 * - Source: external/tixl/Operators/Lib/image/fx/stylize/ScreenCloseUp.cs
 * - Default evidence: external/tixl/Operators/Lib/image/fx/stylize/ScreenCloseUp.t3
 * - Primary output evidence: Output; Texture2D proof color ColorForTextures #9F008A unless noted in acceptance docs.
 *
 * Bounded Vuo body-layer adapter for TiXL evidence `ScreenCloseUp.cs`.
...
VuoModuleMetadata({
 "title":"my_ScreenCloseUp",
 "description":"TiXL ScreenCloseUp bounded Vuo adapter. Source: external/tixl/Operators/Lib/image/fx/stylize/ScreenCloseUp.cs. Category: Operators/Lib/image/fx/stylize. Primary output evidence: Output. Shader/resource evidence: ScreenCloseUp.cs.",
 "keywords":["tixl","image","Texture2D","ScreenCloseUp","ScreenCloseUp.cs","bounded approximation","ColorForTextures","#9F008A"],
 "version":"1.0.0",
...
{ struct nodeInstanceData *instance=(struct nodeInstanceData *)malloc(sizeof(struct nodeInstanceData)); VuoRegister(instance, free); instance->shader=VuoShader_make("my_ScreenCloseUp Shader"); VuoShader_addSource(instance->shader,VuoMesh_IndividualTriangles,NULL,NULL,fragmentShaderSource); VuoRetain(instance->shader); return instance; }
