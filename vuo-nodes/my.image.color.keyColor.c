/**
 * @file
 * my.image.color.keyColor node implementation.
 *
 * TiXL parity contract:
 * - Visible title: my_KeyColor
 * - Category: Operators/Lib/image/color
 * - Source: external/tixl/Operators/Lib/image/color/KeyColor.cs
 * - Default: Texture2d=null, Key=(1,1,1,1), Background=(0,0,0,0), Tolerance=0, Choke=0, Amplify=0, WeightBrightness=10, Exposure=1, Return=0 from KeyColor.t3
 * - Primary output: Texture2D Output (ColorForTextures #9F008A)
 *
 * Bounded Vuo shader adapter for Operators/Lib/Assets/shaders/img/fx/ChromaKey.hlsl.
...
VuoModuleMetadata({
					 "title" : "my_KeyColor",
					 "description" : "TiXL KeyColor bounded Vuo shader adapter. Source: external/tixl/Operators/Lib/image/color/KeyColor.cs. Category: Operators/Lib/image/color. Primary output: Texture2D Output (ColorForTextures #9F008A). Default: Texture2d=null, Key=(1,1,1,1), Background=(0,0,0,0), Tolerance=0, Choke=0, Amplify=0, WeightBrightness=10, Exposure=1, Return=0.",
					 "keywords" : [ "tixl", "texture2d", "image", "color", "KeyColor", "ChromaKey.hlsl", "bounded approximation", "ColorForTextures", "#9F008A" ],
					 "version" : "1.0.0",
...
struct nodeInstanceData * nodeInstanceInit(void)
{
	...
	instance->shader = VuoShader_make("my_KeyColor Shader");
...
)
{
	...
	VuoShader_setUniform_VuoInteger((*instance)->shader, "filterKind", 7);
