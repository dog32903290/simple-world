/**
 * @file
 * my.numbers.vec3.subVec3 node implementation.
 *
 * TiXL parity contract:
 * - Visible title: my_SubVec3
 * - Category: Operators/Lib/numbers/vec3
 * - Source: external/tixl/Operators/Lib/numbers/vec3/SubVec3.cs
...
VuoModuleMetadata({
					 "title" : "my_SubVec3",
					 "description" : "TiXL SubVec3 exact vector adapter. Source: external/tixl/Operators/Lib/numbers/vec3/SubVec3.cs. Category: Operators/Lib/numbers/vec3. Primary output(s): VuoPoint3d Result (ColorForValues #868C8D). ProofValue is Vuo-only.",
...
)
{
	...
	*result = sub3(vectorA, vectorB); proof = length3(*result);
	*proofValue = proof;
}
