/**
 * @file
 * my.image.analyze.removeStaticBackground node implementation.
 *
 * TiXL parity contract:
 * - Visible title: my_RemoveStaticBackground
 * - Category: Operators/Lib/image/analyze
 * - Source: external/tixl/Operators/Lib/image/analyze/RemoveStaticBackground.cs
 * - Default evidence: external/tixl/Operators/Lib/image/analyze/RemoveStaticBackground.t3
 * - Primary output evidence: Output; Texture2D proof color ColorForTextures #9F008A unless noted in acceptance docs.
 *
 * Bounded Vuo body-layer adapter for TiXL evidence `remove-static-background-cs1-learning.hlsl`.
...
VuoModuleMetadata({
 "title":"my_RemoveStaticBackground",
 "description":"TiXL RemoveStaticBackground bounded Vuo adapter. Source: external/tixl/Operators/Lib/image/analyze/RemoveStaticBackground.cs. Category: Operators/Lib/image/analyze. Primary output evidence: Output. Shader/resource evidence: remove-static-background-cs1-learning.hlsl.",
 "keywords":["tixl","image","Texture2D","RemoveStaticBackground","remove-static-background-cs1-learning.hlsl","bounded approximation","ColorForTextures","#9F008A"],
 "version":"1.0.0",
...
{ struct nodeInstanceData *instance=(struct nodeInstanceData *)malloc(sizeof(struct nodeInstanceData)); VuoRegister(instance, free); instance->shader=VuoShader_make("my_RemoveStaticBackground Shader"); VuoShader_addSource(instance->shader,VuoMesh_IndividualTriangles,NULL,NULL,fragmentShaderSource); VuoRetain(instance->shader); return instance; }
