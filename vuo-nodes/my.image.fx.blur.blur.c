/**
 * @file
 * my.image.fx.blur.blur node implementation.
 *
 * TiXL parity contract:
 * - Visible title: my_Blur
 * - Category: Operators/Lib/image/fx/blur
 * - Source: external/tixl/Operators/Lib/image/fx/blur/Blur.cs
 * - Default: Image=null, Size=1, Samples=8, Offset=0, Opacity=1, Resolution=(0,0), Wrap=MirrorOnce from Blur.t3
 * - Primary output: Texture2D TextureOutput (ColorForTextures #9F008A)
 *
 * Bounded Vuo shader adapter for TiXL blur shader evidence including Blur.hlsl.
...
VuoModuleMetadata({
					 "title" : "my_Blur",
					 "description" : "TiXL Blur bounded Vuo shader adapter. Source: external/tixl/Operators/Lib/image/fx/blur/Blur.cs. Category: Operators/Lib/image/fx/blur. Primary output: Texture2D TextureOutput (ColorForTextures #9F008A). Default: Image=null, Size=1, Samples=8, Offset=0, Opacity=1, Resolution=(0,0), Wrap=MirrorOnce.",
					 "keywords" : [ "tixl", "texture2d", "image", "fx", "blur", "Blur", "Blur.hlsl", "bounded approximation", "ColorForTextures", "#9F008A" ],
					 "version" : "1.0.0",
...
struct nodeInstanceData * nodeInstanceInit(void)
{
	...
	instance->shader = VuoShader_make("my_Blur Shader");
