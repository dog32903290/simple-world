/**
 * @file
 * my.image.fx.stylize.colorPhysarum node implementation.
 *
 * TiXL parity contract:
 * - Visible title: my_ColorPhysarum
 * - Category: Operators/Lib/image/fx/stylize
 * - Source: external/tixl/Operators/Lib/image/fx/stylize/ColorPhysarum.cs
 * - Default evidence: external/tixl/Operators/Lib/image/fx/stylize/ColorPhysarum.t3
 * - Primary output evidence: ImgOutput; Texture2D proof color ColorForTextures #9F008A unless noted in acceptance docs.
 *
 * Bounded Vuo body-layer adapter for TiXL evidence `color-physarum-cs.hlsl`.
...
VuoModuleMetadata({
 "title":"my_ColorPhysarum",
 "description":"TiXL ColorPhysarum bounded Vuo adapter. Source: external/tixl/Operators/Lib/image/fx/stylize/ColorPhysarum.cs. Category: Operators/Lib/image/fx/stylize. Primary output evidence: ImgOutput. Shader/resource evidence: color-physarum-cs.hlsl.",
 "keywords":["tixl","image","Texture2D","ColorPhysarum","color-physarum-cs.hlsl","bounded approximation","ColorForTextures","#9F008A"],
 "version":"1.0.0",
...
{ struct nodeInstanceData *instance=(struct nodeInstanceData *)malloc(sizeof(struct nodeInstanceData)); VuoRegister(instance, free); instance->shader=VuoShader_make("my_ColorPhysarum Shader"); VuoShader_addSource(instance->shader,VuoMesh_IndividualTriangles,NULL,NULL,fragmentShaderSource); VuoRetain(instance->shader); return instance; }
...
(
		...
		VuoInputData(VuoImage, {"name":"EffectTexture"}) effectTexture,
