/**
 * @file
 * my.image.color.hse node implementation.
 *
 * TiXL parity contract:
 * - Visible title: my_HSE
 * - Category: Operators/Lib/image/color
 * - Source: external/tixl/Operators/Lib/image/color/HSE.cs
 * - Default: Texture2d=null, FxTexture=null, Hue=0, Saturation=1, Exposure=1 from HSE.t3
 * - Primary output: Texture2D Output (ColorForTextures #9F008A)
 *
 * Bounded Vuo shader adapter for Operators/Lib/Assets/shaders/img/fx/HueShift.hlsl.
...
VuoModuleMetadata({
					 "title" : "my_HSE",
					 "description" : "TiXL HSE bounded Vuo shader adapter. Source: external/tixl/Operators/Lib/image/color/HSE.cs. Category: Operators/Lib/image/color. Primary output: Texture2D Output (ColorForTextures #9F008A). Default: Texture2d=null, FxTexture=null, Hue=0, Saturation=1, Exposure=1.",
					 "keywords" : [ "tixl", "texture2d", "image", "color", "HSE", "HueShift.hlsl", "bounded approximation", "ColorForTextures", "#9F008A" ],
					 "version" : "1.0.0",
...
struct nodeInstanceData * nodeInstanceInit(void)
{
	...
	instance->shader = VuoShader_make("my_HSE Shader");
...
)
{
	...
	VuoShader_setUniform_VuoInteger((*instance)->shader, "filterKind", 6);
