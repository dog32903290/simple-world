/**
 * @file
 * my.image.generate.misc.sketch node implementation.
 *
 * TiXL parity contract:
 * - Visible title: my_Sketch
 * - Category: Operators/Lib/image/generate/misc
 * - Source: external/tixl/Operators/Lib/image/generate/misc/Sketch.cs
 * - Default evidence: external/tixl/Operators/Lib/image/generate/misc/Sketch.t3
 * - Primary output evidence: ColorBuffer; Texture2D proof color ColorForTextures #9F008A unless noted in acceptance docs.
 *
 * Bounded Vuo body-layer adapter for TiXL evidence `Sketch.cs`.
...
VuoModuleMetadata({
 "title":"my_Sketch",
 "description":"TiXL Sketch bounded Vuo adapter. Source: external/tixl/Operators/Lib/image/generate/misc/Sketch.cs. Category: Operators/Lib/image/generate/misc. Primary output evidence: ColorBuffer. Shader/resource evidence: Sketch.cs.",
 "keywords":["tixl","image","Texture2D","Sketch","Sketch.cs","bounded approximation","ColorForTextures","#9F008A"],
 "version":"1.0.0",
...
{ struct nodeInstanceData *instance=(struct nodeInstanceData *)malloc(sizeof(struct nodeInstanceData)); VuoRegister(instance, free); instance->shader=VuoShader_make("my_Sketch Shader"); VuoShader_addSource(instance->shader,VuoMesh_IndividualTriangles,NULL,NULL,fragmentShaderSource); VuoRetain(instance->shader); return instance; }
...
(
		...
		VuoInputData(VuoImage, {"name":"InputImage"}) inputImage,
