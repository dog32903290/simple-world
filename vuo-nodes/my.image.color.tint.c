/**
 * @file
 * my.image.color.tint node implementation.
 *
 * TiXL parity contract:
 * - Visible title: my_Tint
 * - Category: Operators/Lib/image/color
 * - Source: external/tixl/Operators/Lib/image/color/Tint.cs
 * - Default: Texture2d=null, MapBlackTo=(0,0,0,1), MapWhiteTo=(1,1,1,1), Amount=1, Exposure=1, GainAndBias=(0.5,0.5), ChannelWeights=(1,1,1,0) from Tint.t3
 * - Primary output: Texture2D Output (ColorForTextures #9F008A)
 *
 * Bounded Vuo shader adapter for Operators/Lib/Assets/shaders/img/fx/Tint.hlsl.
...
VuoModuleMetadata({
					 "title" : "my_Tint",
					 "description" : "TiXL Tint bounded Vuo shader adapter. Source: external/tixl/Operators/Lib/image/color/Tint.cs. Category: Operators/Lib/image/color. Primary output: Texture2D Output (ColorForTextures #9F008A). Default: Texture2d=null, MapBlackTo=(0,0,0,1), MapWhiteTo=(1,1,1,1), Amount=1, Exposure=1, GainAndBias=(0.5,0.5), ChannelWeights=(1,1,1,0).",
					 "keywords" : [ "tixl", "texture2d", "image", "color", "Tint", "Tint.hlsl", "bounded approximation", "ColorForTextures", "#9F008A" ],
					 "version" : "1.0.0",
...
struct nodeInstanceData * nodeInstanceInit(void)
{
	...
	instance->shader = VuoShader_make("my_Tint Shader");
...
)
{
	...
	VuoShader_setUniform_VuoInteger((*instance)->shader, "filterKind", 9);
