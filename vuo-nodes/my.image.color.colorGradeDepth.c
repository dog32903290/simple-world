/**
 * @file
 * my.image.color.colorGradeDepth node implementation.
 *
 * TiXL parity contract:
 * - Visible title: my_ColorGradeDepth
 * - Category: Operators/Lib/image/color
 * - Source: external/tixl/Operators/Lib/image/color/ColorGradeDepth.cs
 * - Default: Texture2d=null, DepthBuffer=null, Lift/Gamma/Gain=(0.5...), PreSaturate=1, GradientDepthRange=(0.1,100), CamNearFarClip=(0.01,1000) from ColorGradeDepth.t3
 * - Primary output: Texture2D Output (ColorForTextures #9F008A)
 *
 * Bounded Vuo shader adapter for Operators/Lib/Assets/shaders/img/adjust/ColorGradeWithDepth.hlsl.
...
VuoModuleMetadata({
					 "title" : "my_ColorGradeDepth",
					 "description" : "TiXL ColorGradeDepth bounded Vuo shader adapter. Source: external/tixl/Operators/Lib/image/color/ColorGradeDepth.cs. Category: Operators/Lib/image/color. Primary output: Texture2D Output (ColorForTextures #9F008A). Default: Texture2d=null, DepthBuffer=null, Lift/Gamma/Gain=(0.5...), PreSaturate=1, GradientDepthRange=(0.1,100), CamNearFarClip=(0.01,1000).",
					 "keywords" : [ "tixl", "texture2d", "image", "color", "ColorGradeDepth", "ColorGradeWithDepth.hlsl", "bounded approximation", "ColorForTextures", "#9F008A" ],
					 "version" : "1.0.0",
...
struct nodeInstanceData * nodeInstanceInit(void)
{
	...
	instance->shader = VuoShader_make("my_ColorGradeDepth Shader");
...
(
		...
		VuoInputData(VuoColor, {"default":{"r":0.5,"g":0.5,"b":0.5,"a":0.25}}) colorA,
