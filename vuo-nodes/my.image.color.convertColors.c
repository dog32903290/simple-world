/**
 * @file
 * my.image.color.convertColors node implementation.
 *
 * TiXL parity contract:
 * - Visible title: my_ConvertColors
 * - Category: Operators/Lib/image/color
 * - Source: external/tixl/Operators/Lib/image/color/ConvertColors.cs
 * - Default: Texture2d=null, Mode=0, OutputFormat=R32G32B32A32_Float, GenerateMipmaps=false from ConvertColors.t3
 * - Primary output: Texture2D Output (ColorForTextures #9F008A)
 *
 * Bounded Vuo shader adapter for Operators/Lib/Assets/shaders/img/adjust/img-fx-ConvertColors.hlsl.
...
VuoModuleMetadata({
					 "title" : "my_ConvertColors",
					 "description" : "TiXL ConvertColors bounded Vuo shader adapter. Source: external/tixl/Operators/Lib/image/color/ConvertColors.cs. Category: Operators/Lib/image/color. Primary output: Texture2D Output (ColorForTextures #9F008A). Default: Texture2d=null, Mode=0, OutputFormat=R32G32B32A32_Float, GenerateMipmaps=false.",
					 "keywords" : [ "tixl", "texture2d", "image", "color", "ConvertColors", "img-fx-ConvertColors.hlsl", "bounded approximation", "ColorForTextures", "#9F008A" ],
					 "version" : "1.0.0",
...
struct nodeInstanceData * nodeInstanceInit(void)
{
	...
	instance->shader = VuoShader_make("my_ConvertColors Shader");
