/**
 * @file
 * my.numbers.anim.time.setPlaybackSpeed node implementation.
 *
 * TiXL parity contract:
 * - Visible title: my_SetPlaybackSpeed
 * - Category: Operators/Lib/numbers/anim/time
 * - Source: external/tixl/Operators/Lib/numbers/anim/time/SetPlaybackSpeed.cs
 * - Primary output(s): VuoText CommandTrace (ColorForValues #868C8D)
 *
...
VuoModuleMetadata({
					 "title" : "my_SetPlaybackSpeed",
					 "description" : "TiXL SetPlaybackSpeed side-effect bounded adapter. Source: external/tixl/Operators/Lib/numbers/anim/time/SetPlaybackSpeed.cs. Category: Operators/Lib/numbers/anim/time. Primary output(s): VuoText CommandTrace (ColorForValues #868C8D). ProofValue is Vuo-only.",
...
)
{
	...
	*commandTrace = VuoText_make("SetPlaybackSpeed body-layer command trace"); proof = speedFactor;
	*proofValue = proof;
}
