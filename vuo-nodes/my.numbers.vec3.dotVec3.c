/**
 * @file
 * my.numbers.vec3.dotVec3 node implementation.
 *
 * TiXL parity contract:
 * - Visible title: my_DotVec3
 * - Category: Operators/Lib/numbers/vec3
 * - Source: external/tixl/Operators/Lib/numbers/vec3/DotVec3.cs
...
VuoModuleMetadata({
					 "title" : "my_DotVec3",
					 "description" : "TiXL DotVec3 exact vector adapter. Source: external/tixl/Operators/Lib/numbers/vec3/DotVec3.cs. Category: Operators/Lib/numbers/vec3. Primary output(s): VuoReal Result (ColorForValues #868C8D). ProofValue is Vuo-only.",
...
)
{
	...
	*result = dot3(vectorA, vectorB); proof = *result;
	*proofValue = proof;
}
