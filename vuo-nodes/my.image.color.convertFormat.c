/**
 * @file
 * my.image.color.convertFormat node implementation.
 *
 * TiXL parity contract:
 * - Visible title: my_ConvertFormat
 * - Category: Operators/Lib/image/color
 * - Source: external/tixl/Operators/Lib/image/color/ConvertFormat.cs
 * - Default: Texture2d=null, Enable=true, Format=R8G8B8A8_UNorm, ScaleFactor=1, GenerateMipMaps=false from ConvertFormat.t3
 * - Primary output: Texture2D Output (ColorForTextures #9F008A)
 *
 * Bounded Vuo shader adapter for Operators/Lib/Assets/shaders/img/ConvertFormat-cs.hlsl.
...
VuoModuleMetadata({
					 "title" : "my_ConvertFormat",
					 "description" : "TiXL ConvertFormat bounded Vuo shader adapter. Source: external/tixl/Operators/Lib/image/color/ConvertFormat.cs. Category: Operators/Lib/image/color. Primary output: Texture2D Output (ColorForTextures #9F008A). Default: Texture2d=null, Enable=true, Format=R8G8B8A8_UNorm, ScaleFactor=1, GenerateMipMaps=false.",
					 "keywords" : [ "tixl", "texture2d", "image", "color", "ConvertFormat", "ConvertFormat-cs.hlsl", "bounded approximation", "ColorForTextures", "#9F008A" ],
					 "version" : "1.0.0",
...
struct nodeInstanceData * nodeInstanceInit(void)
{
	...
	instance->shader = VuoShader_make("my_ConvertFormat Shader");
...
)
{
	...
	VuoShader_setUniform_VuoInteger((*instance)->shader, "filterKind", 5);
