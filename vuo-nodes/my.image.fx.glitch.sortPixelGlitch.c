/**
 * @file
 * my.image.fx.glitch.sortPixelGlitch node implementation.
 *
 * TiXL parity contract:
 * - Visible title: my_SortPixelGlitch
 * - Category: Operators/Lib/image/fx/glitch
 * - Source: external/tixl/Operators/Lib/image/fx/glitch/SortPixelGlitch.cs
 * - Default: Texture2d=null, Vertical=true, ScanHighlights=false, Threshold=0, Extend=0, BackgroundColor=(1,1,1,1), StreakColor=(1,1,1,1), GradientBias=0.75, ScatterThreshold=0, Offset=0, AddGrain=0, MaxSteps=2000, FadeStreaks=0, LumaBias=0 from SortPixelGlitch.t3
 * - Primary output: Texture2D Output (ColorForTextures #9F008A)
 *
 * Bounded Vuo shader adapter for Operators/Lib/Assets/shaders/img/fx/SortPixelsGlitch-cs.hlsl.
...
VuoModuleMetadata({
					 "title" : "my_SortPixelGlitch",
					 "description" : "TiXL SortPixelGlitch bounded Vuo shader adapter. Source: external/tixl/Operators/Lib/image/fx/glitch/SortPixelGlitch.cs. Category: Operators/Lib/image/fx/glitch. Primary output: Texture2D Output (ColorForTextures #9F008A). Default: Texture2d=null, Vertical=true, ScanHighlights=false, Threshold=0, Extend=0, BackgroundColor=(1,1,1,1), StreakColor=(1,1,1,1), GradientBias=0.75, ScatterThreshold=0, Offset=0, AddGrain=0, MaxSteps=2000, FadeStreaks=0, LumaBias=0.",
					 "keywords" : [ "tixl", "texture2d", "image", "fx", "glitch", "SortPixelGlitch", "SortPixelsGlitch-cs.hlsl", "bounded approximation", "ColorForTextures", "#9F008A" ],
					 "version" : "1.0.0",
...
struct nodeInstanceData * nodeInstanceInit(void)
{
	...
	instance->shader = VuoShader_make("my_SortPixelGlitch Shader");
...
(
		...
		VuoInputData(VuoBoolean, {"default":true}) vertical,
		VuoInputData(VuoBoolean, {"default":false}) scanHighlights,
		VuoInputData(VuoReal, {"default":0.0}) threshold,
		VuoInputData(VuoReal, {"default":0.0}) extend,
		VuoInputData(VuoColor, {"default":{"r":1.0,"g":1.0,"b":1.0,"a":1.0}}) backgroundColor,
		VuoInputData(VuoColor, {"default":{"r":1.0,"g":1.0,"b":1.0,"a":1.0}}) streakColor,
		VuoInputData(VuoReal, {"default":0.75}) gradientBias,
		VuoInputData(VuoReal, {"default":0.0}) scatterThreshold,
		VuoInputData(VuoReal, {"default":0.0}) offset,
		VuoInputData(VuoReal, {"default":0.0}) addGrain,
		VuoInputData(VuoReal, {"default":2000.0}) maxSteps,
		VuoInputData(VuoReal, {"default":0.0}) fadeStreaks,
		VuoInputData(VuoReal, {"default":0.0}) lumaBias,
...
)
{
	...
	VuoShader_setUniform_VuoInteger((*instance)->shader, "filterKind", 2);
	VuoShader_setUniform_VuoPoint2d((*instance)->shader, "targetSize", (VuoPoint2d){renderWidth, renderHeight});
	VuoShader_setUniform_VuoBoolean((*instance)->shader, "vertical", vertical);
	VuoShader_setUniform_VuoBoolean((*instance)->shader, "scanHighlights", scanHighlights);
	VuoShader_setUniform_VuoReal((*instance)->shader, "threshold", threshold);
	VuoShader_setUniform_VuoReal((*instance)->shader, "extend", extend);
	VuoShader_setUniform_VuoColor((*instance)->shader, "backgroundColor", backgroundColor);
	VuoShader_setUniform_VuoColor((*instance)->shader, "streakColor", streakColor);
	VuoShader_setUniform_VuoReal((*instance)->shader, "gradientBias", gradientBias);
	VuoShader_setUniform_VuoReal((*instance)->shader, "scatterThreshold", scatterThreshold);
	VuoShader_setUniform_VuoReal((*instance)->shader, "offset", offset);
	VuoShader_setUniform_VuoReal((*instance)->shader, "addGrain", addGrain);
	VuoShader_setUniform_VuoReal((*instance)->shader, "maxSteps", maxSteps);
	VuoShader_setUniform_VuoReal((*instance)->shader, "fadeStreaks", fadeStreaks);
	VuoShader_setUniform_VuoReal((*instance)->shader, "lumaBias", lumaBias);
