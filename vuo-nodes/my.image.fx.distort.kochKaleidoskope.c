/**
 * @file
 * my.image.fx.distort.kochKaleidoskope node implementation.
 *
 * TiXL parity contract:
 * - Visible title: my_KochKaleidoskope
 * - Category: Operators/Lib/image/fx/distort
 * - Source: external/tixl/Operators/Lib/image/fx/distort/KochKaleidoskope.cs
 * - Default evidence: external/tixl/Operators/Lib/image/fx/distort/KochKaleidoskope.t3
 * - Primary output evidence: TextureOutput; Texture2D proof color ColorForTextures #9F008A unless noted in acceptance docs.
 *
 * Bounded Vuo body-layer adapter for TiXL evidence `KochKaleidoscope.hlsl`.
...
VuoModuleMetadata({
 "title":"my_KochKaleidoskope",
 "description":"TiXL KochKaleidoskope bounded Vuo adapter. Source: external/tixl/Operators/Lib/image/fx/distort/KochKaleidoskope.cs. Category: Operators/Lib/image/fx/distort. Primary output evidence: TextureOutput. Shader/resource evidence: KochKaleidoscope.hlsl.",
 "keywords":["tixl","image","Texture2D","KochKaleidoskope","KochKaleidoscope.hlsl","bounded approximation","ColorForTextures","#9F008A"],
 "version":"1.0.0",
...
{ struct nodeInstanceData *instance=(struct nodeInstanceData *)malloc(sizeof(struct nodeInstanceData)); VuoRegister(instance, free); instance->shader=VuoShader_make("my_KochKaleidoskope Shader"); VuoShader_addSource(instance->shader,VuoMesh_IndividualTriangles,NULL,NULL,fragmentShaderSource); VuoRetain(instance->shader); return instance; }
