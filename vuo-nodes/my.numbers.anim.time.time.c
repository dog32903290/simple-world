/**
 * @file
 * my.numbers.anim.time.time node implementation.
 *
 * TiXL parity contract:
 * - Visible title: my_Time
 * - Category: Operators/Lib/numbers/anim/time
 * - Source: external/tixl/Operators/Lib/numbers/anim/time/Time.cs
 * - Primary output(s): VuoReal Timefloat (ColorForValues #868C8D)
 *
 * bounded scalar time adapter. ProofValue is a Vuo-only numeric tap for the Batch 45 proof composition.
 */
...
VuoModuleMetadata({
					 "title" : "my_Time",
					 "description" : "TiXL Time bounded scalar time adapter. Source: external/tixl/Operators/Lib/numbers/anim/time/Time.cs. Category: Operators/Lib/numbers/anim/time. Primary output(s): VuoReal Timefloat (ColorForValues #868C8D). ProofValue is Vuo-only.",
