/**
 * @file
 * my.image.generate.pattern.fraserGrid node implementation.
 *
 * TiXL parity contract:
 * - Visible title: my_FraserGrid
 * - Category: Operators/Lib/image/generate/pattern
 * - Source: external/tixl/Operators/Lib/image/generate/pattern/FraserGrid.cs
 * - Default: Image=null, Fill=(0,0,0,1), FillB=(1,1,1,1), Background=(0.67475104,0.67498636,0.67569184,1), Feather=0.015, Size=(1,1), Offset=(0,0), Scale=4, Rotate=0, RotateShapes=45, ShapeSize=0.22, BarWidth=0.035, BorderWidth=0.06, RowSwift=0, RAffects_BarWidth=0, GAffects_ShapeSize=0, BAffects_LineRatio=0, Resolution=(0,0) from FraserGrid.t3
 * - Primary output: Texture2D TextureOutput (ColorForTextures #9F008A)
 *
 * Bounded Vuo shader adapter for external/tixl/Operators/Lib/Assets/shaders/img/{fx or generate}/FraserGrid.hlsl.
...
VuoModuleMetadata({
					 "title" : "my_FraserGrid",
					 "description" : "TiXL FraserGrid bounded Vuo shader adapter. Source: external/tixl/Operators/Lib/image/generate/pattern/FraserGrid.cs. Category: Operators/Lib/image/generate/pattern. Primary output: Texture2D TextureOutput (ColorForTextures #9F008A). Default: Image=null, Fill=(0,0,0,1), FillB=(1,1,1,1), Background=(0.67475104,0.67498636,0.67569184,1), Feather=0.015, Size=(1,1), Offset=(0,0), Scale=4, Rotate=0, RotateShapes=45, ShapeSize=0.22, BarWidth=0.035, BorderWidth=0.06, RowSwift=0, RAffects_BarWidth=0, GAffects_ShapeSize=0, BAffects_LineRatio=0, Resolution=(0,0).",
					 "keywords" : [ "tixl", "texture2d", "image", "generate", "pattern", "FraserGrid", "FraserGrid.hlsl", "bounded approximation", "ColorForTextures", "#9F008A" ],
					 "version" : "1.0.0",
...
struct nodeInstanceData * nodeInstanceInit(void)
{
	...
	instance->shader = VuoShader_make("my_FraserGrid Shader");
...
)
{
	...
	VuoShader_setUniform_VuoInteger((*instance)->shader, "patternKind", 0);
