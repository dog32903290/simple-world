/**
 * @file
 * my.image.generate.pattern.raster node implementation.
 *
 * TiXL parity contract:
 * - Visible title: my_Raster
 * - Category: Operators/Lib/image/generate/pattern
 * - Source: external/tixl/Operators/Lib/image/generate/pattern/Raster.cs
 * - Default: Image=null, Offset=(0,0), Rotate=0, Stretch=(1,1), Scale=4, Color=(1,1,1,1), Background=(0,0,0,0), MixOriginal=1, Resolution=(0,0), DotSize=0.05333333, LineWidth=0.053333342, LineRatio=0.75, Feather=0.02, RedToDotSize=0, GreenToLineWidth=0, BlueToLineRatio=0 from Raster.t3
 * - Primary output: Texture2D TextureOutput (ColorForTextures #9F008A)
 *
 * Bounded Vuo shader adapter for external/tixl/Operators/Lib/Assets/shaders/img/{fx or generate}/Raster.hlsl.
...
VuoModuleMetadata({
					 "title" : "my_Raster",
					 "description" : "TiXL Raster bounded Vuo shader adapter. Source: external/tixl/Operators/Lib/image/generate/pattern/Raster.cs. Category: Operators/Lib/image/generate/pattern. Primary output: Texture2D TextureOutput (ColorForTextures #9F008A). Default: Image=null, Offset=(0,0), Rotate=0, Stretch=(1,1), Scale=4, Color=(1,1,1,1), Background=(0,0,0,0), MixOriginal=1, Resolution=(0,0), DotSize=0.05333333, LineWidth=0.053333342, LineRatio=0.75, Feather=0.02, RedToDotSize=0, GreenToLineWidth=0, BlueToLineRatio=0.",
					 "keywords" : [ "tixl", "texture2d", "image", "generate", "pattern", "Raster", "Raster.hlsl", "bounded approximation", "ColorForTextures", "#9F008A" ],
					 "version" : "1.0.0",
...
struct nodeInstanceData * nodeInstanceInit(void)
{
	...
	instance->shader = VuoShader_make("my_Raster Shader");
...
)
{
	...
	VuoShader_setUniform_VuoInteger((*instance)->shader, "patternKind", 2);
