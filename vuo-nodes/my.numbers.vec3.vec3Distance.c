/**
 * @file
 * my.numbers.vec3.vec3Distance node implementation.
 *
 * TiXL parity contract:
 * - Visible title: my_Vec3Distance
 * - Category: Operators/Lib/numbers/vec3
 * - Source: external/tixl/Operators/Lib/numbers/vec3/Vec3Distance.cs
...
VuoModuleMetadata({
					 "title" : "my_Vec3Distance",
					 "description" : "TiXL Vec3Distance exact vector adapter. Source: external/tixl/Operators/Lib/numbers/vec3/Vec3Distance.cs. Category: Operators/Lib/numbers/vec3. Primary output(s): VuoReal Result (ColorForValues #868C8D). ProofValue is Vuo-only.",
...
)
{
	...
	*result = length3(sub3(vectorA, vectorB)); proof = *result;
	*proofValue = proof;
}
