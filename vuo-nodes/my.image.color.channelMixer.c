/**
 * @file
 * my.image.color.channelMixer node implementation.
 *
 * TiXL parity contract:
 * - Visible title: my_ChannelMixer
 * - Category: Operators/Lib/image/color
 * - Source: external/tixl/Operators/Lib/image/color/ChannelMixer.cs
 * - Default: Texture2d=null, MultiplyR=(1,0,0,0), MultiplyG=(0,1,0,0), MultiplyB=(0,0,1,0), Add=(0,0,0,0), ClampResult=true, GenerateMipmaps=false from ChannelMixer.t3
 * - Primary output: Texture2D Output (ColorForTextures #9F008A)
 *
 * Bounded Vuo shader adapter for Operators/Lib/Assets/shaders/img/MixChannels.hlsl.
...
VuoModuleMetadata({
					 "title" : "my_ChannelMixer",
					 "description" : "TiXL ChannelMixer bounded Vuo shader adapter. Source: external/tixl/Operators/Lib/image/color/ChannelMixer.cs. Category: Operators/Lib/image/color. Primary output: Texture2D Output (ColorForTextures #9F008A). Default: Texture2d=null, MultiplyR=(1,0,0,0), MultiplyG=(0,1,0,0), MultiplyB=(0,0,1,0), Add=(0,0,0,0), ClampResult=true, GenerateMipmaps=false.",
					 "keywords" : [ "tixl", "texture2d", "image", "color", "ChannelMixer", "MixChannels.hlsl", "bounded approximation", "ColorForTextures", "#9F008A" ],
					 "version" : "1.0.0",
...
struct nodeInstanceData * nodeInstanceInit(void)
{
	...
	instance->shader = VuoShader_make("my_ChannelMixer Shader");
...
(
		...
		VuoInputData(VuoColor, {"default":{"r":1.0,"g":0.0,"b":0.0,"a":0.0}}) colorA,
		VuoInputData(VuoColor, {"default":{"r":0.0,"g":1.0,"b":0.0,"a":0.0}}) colorB,
		VuoInputData(VuoColor, {"default":{"r":0.0,"g":0.0,"b":1.0,"a":0.0}}) colorC,
