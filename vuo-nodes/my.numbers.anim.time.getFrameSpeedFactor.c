/**
 * @file
 * my.numbers.anim.time.getFrameSpeedFactor node implementation.
 *
 * TiXL parity contract:
 * - Visible title: my_GetFrameSpeedFactor
 * - Category: Operators/Lib/numbers/anim/time
 * - Source: external/tixl/Operators/Lib/numbers/anim/time/GetFrameSpeedFactor.cs
 * - Primary output(s): VuoReal FrameSpeedFactor (ColorForValues #868C8D)
 *
 * exact scalar adapter. ProofValue is a Vuo-only numeric tap for the Batch 45 proof composition.
 */
...
VuoModuleMetadata({
					 "title" : "my_GetFrameSpeedFactor",
					 "description" : "TiXL GetFrameSpeedFactor exact scalar adapter. Source: external/tixl/Operators/Lib/numbers/anim/time/GetFrameSpeedFactor.cs. Category: Operators/Lib/numbers/anim/time. Primary output(s): VuoReal FrameSpeedFactor (ColorForValues #868C8D). ProofValue is Vuo-only.",
