/**
 * @file
 * my.image.color.remapColor node implementation.
 *
 * TiXL parity contract:
 * - Visible title: my_RemapColor
 * - Category: Operators/Lib/image/color
 * - Source: external/tixl/Operators/Lib/image/color/RemapColor.cs
 * - Default: Image=null, Gradient=black-to-white, Mode=1, GainAndBias=(0.5,0.5), Exposure=1, Cycle=0, DontColorAlpha=false, GradientSteps=256 from RemapColor.t3
 * - Primary output: Texture2D TextureOutput (ColorForTextures #9F008A)
 *
 * Bounded Vuo shader adapter for Operators/Lib/Assets/shaders/img/fx/ColorRemap.hlsl.
...
VuoModuleMetadata({
					 "title" : "my_RemapColor",
					 "description" : "TiXL RemapColor bounded Vuo shader adapter. Source: external/tixl/Operators/Lib/image/color/RemapColor.cs. Category: Operators/Lib/image/color. Primary output: Texture2D TextureOutput (ColorForTextures #9F008A). Default: Image=null, Gradient=black-to-white, Mode=1, GainAndBias=(0.5,0.5), Exposure=1, Cycle=0, DontColorAlpha=false, GradientSteps=256.",
					 "keywords" : [ "tixl", "texture2d", "image", "color", "RemapColor", "ColorRemap.hlsl", "bounded approximation", "ColorForTextures", "#9F008A" ],
					 "version" : "1.0.0",
...
struct nodeInstanceData * nodeInstanceInit(void)
{
	...
	instance->shader = VuoShader_make("my_RemapColor Shader");
...
(
		...
		VuoInputData(VuoReal, {"default":1.0}) mode,
...
)
{
	...
	VuoShader_setUniform_VuoInteger((*instance)->shader, "filterKind", 8);
