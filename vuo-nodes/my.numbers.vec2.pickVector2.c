/**
 * @file
 * my.numbers.vec2.pickVector2 node implementation.
 *
 * TiXL parity contract:
 * - Visible title: my_PickVector2
 * - Category: Operators/Lib/numbers/vec2
 * - Source: external/tixl/Operators/Lib/numbers/vec2/PickVector2.cs
 * - Primary output(s): VuoPoint2d Selected (ColorForValues #868C8D)
 *
 * bounded selector adapter. ProofValue is a Vuo-only numeric tap for the Batch 49 proof composition.
 */
...
VuoModuleMetadata({
					 "title" : "my_PickVector2",
					 "description" : "TiXL PickVector2 bounded selector adapter. Source: external/tixl/Operators/Lib/numbers/vec2/PickVector2.cs. Category: Operators/Lib/numbers/vec2. Primary output(s): VuoPoint2d Selected (ColorForValues #868C8D). ProofValue is Vuo-only.",
