/**
 * @file
 * my.numbers.bool.process.delayBoolean node implementation.
 *
 * TiXL parity contract:
 * - Visible title: my_DelayBoolean
 * - Category: Operators/Lib/numbers/bool/process
 * - Source: external/tixl/Operators/Lib/numbers/bool/process/DelayBoolean.cs
 * - Primary output(s): VuoBoolean DelayedTrigger (ColorForValues #868C8D)
 *
...
VuoModuleMetadata({
					 "title" : "my_DelayBoolean",
					 "description" : "TiXL DelayBoolean bounded stateless delay adapter. Source: external/tixl/Operators/Lib/numbers/bool/process/DelayBoolean.cs. Category: Operators/Lib/numbers/bool/process. Primary output(s): VuoBoolean DelayedTrigger (ColorForValues #868C8D). ProofValue is Vuo-only.",
...
)
{
	...
	*delayedTrigger = frameCount <= 0 ? trigger : false; proof = *delayedTrigger ? 1.0 : 0.0;
	*proofValue = proof;
}
