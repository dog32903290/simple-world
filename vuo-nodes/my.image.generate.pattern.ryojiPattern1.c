/**
 * @file
 * my.image.generate.pattern.ryojiPattern1 node implementation.
 *
 * TiXL parity contract:
 * - Visible title: my_RyojiPattern1
 * - Category: Operators/Lib/image/generate/pattern
 * - Source: external/tixl/Operators/Lib/image/generate/pattern/RyojiPattern1.cs
 * - Default: Image=null, Background=(0,0,0,1), Foreground=(1,1,1,1), MixOriginal=0, Contrast=0.75, ForgroundRatio=0.5, Highlight=(1,0,0,1), HighlightProbability=0.01, HighlightSeed=0, Iterations=7, Splits=(0,0), SplitProbability=(0,0), ScrollSpeed=(0,0), ScrollProbability=(0,0), Padding=(0,0), Seed=42, Resolution=(0,0), GenerateMipmaps=false from RyojiPattern1.t3
 * - Primary output: Texture2D TextureOutput (ColorForTextures #9F008A)
 *
 * Bounded Vuo shader adapter for external/tixl/Operators/Lib/Assets/shaders/img/{fx or generate}/RyojiPattern1.hlsl.
...
VuoModuleMetadata({
					 "title" : "my_RyojiPattern1",
					 "description" : "TiXL RyojiPattern1 bounded Vuo shader adapter. Source: external/tixl/Operators/Lib/image/generate/pattern/RyojiPattern1.cs. Category: Operators/Lib/image/generate/pattern. Primary output: Texture2D TextureOutput (ColorForTextures #9F008A). Default: Image=null, Background=(0,0,0,1), Foreground=(1,1,1,1), MixOriginal=0, Contrast=0.75, ForgroundRatio=0.5, Highlight=(1,0,0,1), HighlightProbability=0.01, HighlightSeed=0, Iterations=7, Splits=(0,0), SplitProbability=(0,0), ScrollSpeed=(0,0), ScrollProbability=(0,0), Padding=(0,0), Seed=42, Resolution=(0,0), GenerateMipmaps=false.",
					 "keywords" : [ "tixl", "texture2d", "image", "generate", "pattern", "RyojiPattern1", "RyojiPattern1.hlsl", "bounded approximation", "ColorForTextures", "#9F008A" ],
					 "version" : "1.0.0",
...
struct nodeInstanceData * nodeInstanceInit(void)
{
	...
	instance->shader = VuoShader_make("my_RyojiPattern1 Shader");
...
)
{
	...
	VuoShader_setUniform_VuoInteger((*instance)->shader, "patternKind", 4);
