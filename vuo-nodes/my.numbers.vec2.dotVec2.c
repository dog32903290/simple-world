/**
 * @file
 * my.numbers.vec2.dotVec2 node implementation.
 *
 * TiXL parity contract:
 * - Visible title: my_DotVec2
 * - Category: Operators/Lib/numbers/vec2
 * - Source: external/tixl/Operators/Lib/numbers/vec2/DotVec2.cs
...
VuoModuleMetadata({
					 "title" : "my_DotVec2",
					 "description" : "TiXL DotVec2 exact vector adapter. Source: external/tixl/Operators/Lib/numbers/vec2/DotVec2.cs. Category: Operators/Lib/numbers/vec2. Primary output(s): VuoReal Result (ColorForValues #868C8D). ProofValue is Vuo-only.",
...
)
{
	...
	*result = input1.x * input2.x + input1.y * input2.y; proof = *result;
	*proofValue = proof;
}
