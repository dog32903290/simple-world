/**
 * @file
 * my.image.generate.load.loadSvgAsTexture2D node implementation.
 *
 * TiXL parity contract:
 * - Visible title: my_LoadSvgAsTexture2D
 * - Category: Operators/Lib/image/generate/load
 * - Source: external/tixl/Operators/Lib/image/generate/load/LoadSvgAsTexture2D.cs
 * - Default evidence: external/tixl/Operators/Lib/image/generate/load/LoadSvgAsTexture2D.t3
 * - Primary output evidence: Texture; Texture2D proof color ColorForTextures #9F008A unless noted in acceptance docs.
 *
 * Bounded Vuo body-layer adapter for TiXL evidence `LoadSvgAsTexture2D.cs`.
...
VuoModuleMetadata({
 "title":"my_LoadSvgAsTexture2D",
 "description":"TiXL LoadSvgAsTexture2D bounded Vuo adapter. Source: external/tixl/Operators/Lib/image/generate/load/LoadSvgAsTexture2D.cs. Category: Operators/Lib/image/generate/load. Primary output evidence: Texture. Shader/resource evidence: LoadSvgAsTexture2D.cs.",
 "keywords":["tixl","image","Texture2D","LoadSvgAsTexture2D","LoadSvgAsTexture2D.cs","bounded approximation","ColorForTextures","#9F008A"],
 "version":"1.0.0",
...
{ struct nodeInstanceData *instance=(struct nodeInstanceData *)malloc(sizeof(struct nodeInstanceData)); VuoRegister(instance, free); instance->shader=VuoShader_make("my_LoadSvgAsTexture2D Shader"); VuoShader_addSource(instance->shader,VuoMesh_IndividualTriangles,NULL,NULL,fragmentShaderSource); VuoRetain(instance->shader); return instance; }
