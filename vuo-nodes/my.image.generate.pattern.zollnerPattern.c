/**
 * @file
 * my.image.generate.pattern.zollnerPattern node implementation.
 *
 * TiXL parity contract:
 * - Visible title: my_ZollnerPattern
 * - Category: Operators/Lib/image/generate/pattern
 * - Source: external/tixl/Operators/Lib/image/generate/pattern/ZollnerPattern.cs
 * - Default: Image=null, Fill=(0,0,0,1), Background=(1,1,1,1), Stretch=(1,1), Offset=(0,0), Scale=1, Rotate=45, Feather=0.02, BarWidth=0.2, HookRotation=60, HookLength=0.7, HookWidth=0.33, RowSwift=0, RAffects_BarWidth=0, GAffects_HookLength=0, BAffects_HookRotation=0, Resolution=(0,0), AmplifyIllusion=0 from ZollnerPattern.t3
 * - Primary output: Texture2D TextureOutput (ColorForTextures #9F008A)
 *
 * Bounded Vuo shader adapter for external/tixl/Operators/Lib/Assets/shaders/img/{fx or generate}/ZollnerGrid.hlsl.
...
VuoModuleMetadata({
					 "title" : "my_ZollnerPattern",
					 "description" : "TiXL ZollnerPattern bounded Vuo shader adapter. Source: external/tixl/Operators/Lib/image/generate/pattern/ZollnerPattern.cs. Category: Operators/Lib/image/generate/pattern. Primary output: Texture2D TextureOutput (ColorForTextures #9F008A). Default: Image=null, Fill=(0,0,0,1), Background=(1,1,1,1), Stretch=(1,1), Offset=(0,0), Scale=1, Rotate=45, Feather=0.02, BarWidth=0.2, HookRotation=60, HookLength=0.7, HookWidth=0.33, RowSwift=0, RAffects_BarWidth=0, GAffects_HookLength=0, BAffects_HookRotation=0, Resolution=(0,0), AmplifyIllusion=0.",
					 "keywords" : [ "tixl", "texture2d", "image", "generate", "pattern", "ZollnerPattern", "ZollnerGrid.hlsl", "bounded approximation", "ColorForTextures", "#9F008A" ],
					 "version" : "1.0.0",
...
struct nodeInstanceData * nodeInstanceInit(void)
{
	...
	instance->shader = VuoShader_make("my_ZollnerPattern Shader");
...
)
{
	...
	VuoShader_setUniform_VuoInteger((*instance)->shader, "patternKind", 8);
