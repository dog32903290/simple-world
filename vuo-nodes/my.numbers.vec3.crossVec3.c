/**
 * @file
 * my.numbers.vec3.crossVec3 node implementation.
 *
 * TiXL parity contract:
 * - Visible title: my_CrossVec3
 * - Category: Operators/Lib/numbers/vec3
 * - Source: external/tixl/Operators/Lib/numbers/vec3/CrossVec3.cs
...
VuoModuleMetadata({
					 "title" : "my_CrossVec3",
					 "description" : "TiXL CrossVec3 exact vector adapter. Source: external/tixl/Operators/Lib/numbers/vec3/CrossVec3.cs. Category: Operators/Lib/numbers/vec3. Primary output(s): VuoPoint3d Result (ColorForValues #868C8D). ProofValue is Vuo-only.",
...
)
{
	...
	*result = cross3(vectorA, vectorB); proof = length3(*result);
	*proofValue = proof;
}
