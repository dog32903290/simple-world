/**
 * @file
 * my.image.generate.pattern.rings node implementation.
 *
 * TiXL parity contract:
 * - Visible title: my_Rings
 * - Category: Operators/Lib/image/generate/pattern
 * - Source: external/tixl/Operators/Lib/image/generate/pattern/Rings.cs
 * - Default: Image=null, Fill=(1,1,1,1), Background=(0,0,0,0), Highlight=(1,0,0,1), Radius=(1,1), Position=(0,0), Count=0.5, Feather=0.03333335, Rotate=0, Offset=0, _Segments=(20,0), _Twist=(0,0), _Thickness=(0.5,0), _Ratio=(1.05,0), _FillRatio=1, _HighlightRatio=0, HighlightSeed=0, Distort=1, Constrast=1, Resolution=(0,0), Seed=0, BlendMode=0 from Rings.t3
 * - Primary output: Texture2D TextureOutput (ColorForTextures #9F008A)
 *
 * Bounded Vuo shader adapter for external/tixl/Operators/Lib/Assets/shaders/img/{fx or generate}/Rings.hlsl.
...
VuoModuleMetadata({
					 "title" : "my_Rings",
					 "description" : "TiXL Rings bounded Vuo shader adapter. Source: external/tixl/Operators/Lib/image/generate/pattern/Rings.cs. Category: Operators/Lib/image/generate/pattern. Primary output: Texture2D TextureOutput (ColorForTextures #9F008A). Default: Image=null, Fill=(1,1,1,1), Background=(0,0,0,0), Highlight=(1,0,0,1), Radius=(1,1), Position=(0,0), Count=0.5, Feather=0.03333335, Rotate=0, Offset=0, _Segments=(20,0), _Twist=(0,0), _Thickness=(0.5,0), _Ratio=(1.05,0), _FillRatio=1, _HighlightRatio=0, HighlightSeed=0, Distort=1, Constrast=1, Resolution=(0,0), Seed=0, BlendMode=0.",
					 "keywords" : [ "tixl", "texture2d", "image", "generate", "pattern", "Rings", "Rings.hlsl", "bounded approximation", "ColorForTextures", "#9F008A" ],
					 "version" : "1.0.0",
...
struct nodeInstanceData * nodeInstanceInit(void)
{
	...
	instance->shader = VuoShader_make("my_Rings Shader");
...
)
{
	...
	VuoShader_setUniform_VuoInteger((*instance)->shader, "patternKind", 3);
