/**
 * @file
 * my.image.generate.pattern.sinForm node implementation.
 *
 * TiXL parity contract:
 * - Visible title: my_SinForm
 * - Category: Operators/Lib/image/generate/pattern
 * - Source: external/tixl/Operators/Lib/image/generate/pattern/SinForm.cs
 * - Default: Image=null, Fill=(1,1,1,1), Background=(0,0,0,0), LineWidth=0.04333334, Fade=1, Size=(1,1), Offset=(0,0), Rotate=0, Copies=0, OffsetCopies=(0,0.05), Resolution=(0,0), TextureFormat=R16G16B16A16_Float from SinForm.t3
 * - Primary output: Texture2D TextureOutput (ColorForTextures #9F008A)
 *
 * Bounded Vuo shader adapter for external/tixl/Operators/Lib/Assets/shaders/img/{fx or generate}/SinForm.hlsl.
...
VuoModuleMetadata({
					 "title" : "my_SinForm",
					 "description" : "TiXL SinForm bounded Vuo shader adapter. Source: external/tixl/Operators/Lib/image/generate/pattern/SinForm.cs. Category: Operators/Lib/image/generate/pattern. Primary output: Texture2D TextureOutput (ColorForTextures #9F008A). Default: Image=null, Fill=(1,1,1,1), Background=(0,0,0,0), LineWidth=0.04333334, Fade=1, Size=(1,1), Offset=(0,0), Rotate=0, Copies=0, OffsetCopies=(0,0.05), Resolution=(0,0), TextureFormat=R16G16B16A16_Float.",
					 "keywords" : [ "tixl", "texture2d", "image", "generate", "pattern", "SinForm", "SinForm.hlsl", "bounded approximation", "ColorForTextures", "#9F008A" ],
					 "version" : "1.0.0",
...
struct nodeInstanceData * nodeInstanceInit(void)
{
	...
	instance->shader = VuoShader_make("my_SinForm Shader");
...
)
{
	...
	VuoShader_setUniform_VuoInteger((*instance)->shader, "patternKind", 6);
