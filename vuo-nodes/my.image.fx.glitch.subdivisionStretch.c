/**
 * @file
 * my.image.fx.glitch.subdivisionStretch node implementation.
 *
 * TiXL parity contract:
 * - Visible title: my_SubdivisionStretch
 * - Category: Operators/Lib/image/fx/glitch
 * - Source: external/tixl/Operators/Lib/image/fx/glitch/SubdivisionStretch.cs
 * - Default: Image=null, MaxSubdivisions=17, Threshold=0.1, UseAspectForSplit=false, SplitCenter=0.5, SplitCenterVariation=0.7, DirectionBias=0, ScrollOffset=(0,0), RandomPhase=0, RandomSeed=42, GapWidth=0.001, Feather=0.0005, GapColor=(0,0,0,1), GradientMode=0, ColorMode=0, Use4xMSAA=false, TextureFx=0 from SubdivisionStretch.t3
 * - Primary output: Texture2D TextureOutput (ColorForTextures #9F008A)
 *
 * Bounded Vuo shader adapter for Operators/Lib/Assets/shaders/img/fx/StretchSubdivide.hlsl.
...
VuoModuleMetadata({
					 "title" : "my_SubdivisionStretch",
					 "description" : "TiXL SubdivisionStretch bounded Vuo shader adapter. Source: external/tixl/Operators/Lib/image/fx/glitch/SubdivisionStretch.cs. Category: Operators/Lib/image/fx/glitch. Primary output: Texture2D TextureOutput (ColorForTextures #9F008A). Default: Image=null, MaxSubdivisions=17, Threshold=0.1, UseAspectForSplit=false, SplitCenter=0.5, SplitCenterVariation=0.7, DirectionBias=0, ScrollOffset=(0,0), RandomPhase=0, RandomSeed=42, GapWidth=0.001, Feather=0.0005, GapColor=(0,0,0,1), GradientMode=0, ColorMode=0, Use4xMSAA=false, TextureFx=0.",
					 "keywords" : [ "tixl", "texture2d", "image", "fx", "glitch", "SubdivisionStretch", "StretchSubdivide.hlsl", "bounded approximation", "ColorForTextures", "#9F008A" ],
					 "version" : "1.0.0",
...
struct nodeInstanceData * nodeInstanceInit(void)
{
	...
	instance->shader = VuoShader_make("my_SubdivisionStretch Shader");
...
(
		...
		VuoInputData(VuoInteger, {"default":17}) maxSubdivisions,
		VuoInputData(VuoReal, {"default":0.1}) threshold,
		VuoInputData(VuoBoolean, {"default":false}) useAspectForSplit,
		VuoInputData(VuoReal, {"default":0.5}) splitCenter,
		VuoInputData(VuoReal, {"default":0.7}) splitCenterVariation,
		VuoInputData(VuoReal, {"default":0.0}) directionBias,
		VuoInputData(VuoPoint2d, {"default":{"x":0.0,"y":0.0}}) scrollOffset,
		VuoInputData(VuoReal, {"default":0.0}) randomPhase,
		VuoInputData(VuoInteger, {"default":42}) randomSeed,
		VuoInputData(VuoReal, {"default":0.001}) gapWidth,
		VuoInputData(VuoReal, {"default":0.0005}) feather,
		VuoInputData(VuoColor, {"default":{"r":0.0,"g":0.0,"b":0.0,"a":1.0}}) gapColor,
		VuoInputData(VuoReal, {"default":0.0}) textureFx,
...
)
{
	...
	VuoShader_setUniform_VuoInteger((*instance)->shader, "filterKind", 3);
	VuoShader_setUniform_VuoPoint2d((*instance)->shader, "targetSize", (VuoPoint2d){renderWidth, renderHeight});
	VuoShader_setUniform_VuoInteger((*instance)->shader, "maxSubdivisions", maxSubdivisions);
	VuoShader_setUniform_VuoReal((*instance)->shader, "threshold", threshold);
	VuoShader_setUniform_VuoBoolean((*instance)->shader, "useAspectForSplit", useAspectForSplit);
	VuoShader_setUniform_VuoReal((*instance)->shader, "splitCenter", splitCenter);
	VuoShader_setUniform_VuoReal((*instance)->shader, "splitCenterVariation", splitCenterVariation);
	VuoShader_setUniform_VuoReal((*instance)->shader, "directionBias", directionBias);
	VuoShader_setUniform_VuoPoint2d((*instance)->shader, "scrollOffset", scrollOffset);
	VuoShader_setUniform_VuoReal((*instance)->shader, "randomPhase", randomPhase);
	VuoShader_setUniform_VuoInteger((*instance)->shader, "randomSeed", randomSeed);
	VuoShader_setUniform_VuoReal((*instance)->shader, "gapWidth", gapWidth);
	VuoShader_setUniform_VuoReal((*instance)->shader, "feather", feather);
	VuoShader_setUniform_VuoColor((*instance)->shader, "gapColor", gapColor);
	VuoShader_setUniform_VuoReal((*instance)->shader, "textureFx", textureFx);
