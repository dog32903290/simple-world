/**
 * @file
 * my.image.generate.load.loadImageFromUrl node implementation.
 *
 * TiXL parity contract:
 * - Visible title: my_LoadImageFromUrl
 * - Category: Operators/Lib/image/generate/load
 * - Source: external/tixl/Operators/Lib/image/generate/load/LoadImageFromUrl.cs
 * - Default evidence: external/tixl/Operators/Lib/image/generate/load/LoadImageFromUrl.t3
 * - Primary output evidence: Texture; Texture2D proof color ColorForTextures #9F008A unless noted in acceptance docs.
 *
 * Bounded Vuo body-layer adapter for TiXL evidence `LoadImageFromUrl.cs`.
...
VuoModuleMetadata({
 "title":"my_LoadImageFromUrl",
 "description":"TiXL LoadImageFromUrl bounded Vuo adapter. Source: external/tixl/Operators/Lib/image/generate/load/LoadImageFromUrl.cs. Category: Operators/Lib/image/generate/load. Primary output evidence: Texture. Shader/resource evidence: LoadImageFromUrl.cs.",
 "keywords":["tixl","image","Texture2D","LoadImageFromUrl","LoadImageFromUrl.cs","bounded approximation","ColorForTextures","#9F008A"],
 "version":"1.0.0",
...
{ struct nodeInstanceData *instance=(struct nodeInstanceData *)malloc(sizeof(struct nodeInstanceData)); VuoRegister(instance, free); instance->shader=VuoShader_make("my_LoadImageFromUrl Shader"); VuoShader_addSource(instance->shader,VuoMesh_IndividualTriangles,NULL,NULL,fragmentShaderSource); VuoRetain(instance->shader); return instance; }
