/**
 * @file
 * my.image.color.colorGrade node implementation.
 *
 * TiXL parity contract:
 * - Visible title: my_ColorGrade
 * - Category: Operators/Lib/image/color
 * - Source: external/tixl/Operators/Lib/image/color/ColorGrade.cs
 * - Default: Texture2d=null, Lift=(0.5,0.5,0.5,0.25), Gamma=(0.5,0.5,0.5,0.506), Gain=(0.5,0.5,0.5,0.506), PreSaturate=1, ClampResult=false, VignetteCenter=(0,0) from ColorGrade.t3
 * - Primary output: Texture2D Output (ColorForTextures #9F008A)
 *
 * Bounded Vuo shader adapter for Operators/Lib/Assets/shaders/img/ColorGrade.hlsl.
...
VuoModuleMetadata({
					 "title" : "my_ColorGrade",
					 "description" : "TiXL ColorGrade bounded Vuo shader adapter. Source: external/tixl/Operators/Lib/image/color/ColorGrade.cs. Category: Operators/Lib/image/color. Primary output: Texture2D Output (ColorForTextures #9F008A). Default: Texture2d=null, Lift=(0.5,0.5,0.5,0.25), Gamma=(0.5,0.5,0.5,0.506), Gain=(0.5,0.5,0.5,0.506), PreSaturate=1, ClampResult=false, VignetteCenter=(0,0).",
					 "keywords" : [ "tixl", "texture2d", "image", "color", "ColorGrade", "ColorGrade.hlsl", "bounded approximation", "ColorForTextures", "#9F008A" ],
					 "version" : "1.0.0",
...
struct nodeInstanceData * nodeInstanceInit(void)
{
	...
	instance->shader = VuoShader_make("my_ColorGrade Shader");
