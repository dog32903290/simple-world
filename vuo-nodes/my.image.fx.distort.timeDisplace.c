/**
 * @file
 * my.image.fx.distort.timeDisplace node implementation.
 *
 * TiXL parity contract:
 * - Visible title: my_TimeDisplace
 * - Category: Operators/Lib/image/fx/distort
 * - Source: external/tixl/Operators/Lib/image/fx/distort/TimeDisplace.cs
 * - Default evidence: external/tixl/Operators/Lib/image/fx/distort/TimeDisplace.t3
 * - Primary output evidence: Output; Texture2D proof color ColorForTextures #9F008A unless noted in acceptance docs.
 *
 * Bounded Vuo body-layer adapter for TiXL evidence `TimeDisplace.hlsl`.
...
VuoModuleMetadata({
 "title":"my_TimeDisplace",
 "description":"TiXL TimeDisplace bounded Vuo adapter. Source: external/tixl/Operators/Lib/image/fx/distort/TimeDisplace.cs. Category: Operators/Lib/image/fx/distort. Primary output evidence: Output. Shader/resource evidence: TimeDisplace.hlsl.",
 "keywords":["tixl","image","Texture2D","TimeDisplace","TimeDisplace.hlsl","bounded approximation","ColorForTextures","#9F008A"],
 "version":"1.0.0",
...
{ struct nodeInstanceData *instance=(struct nodeInstanceData *)malloc(sizeof(struct nodeInstanceData)); VuoRegister(instance, free); instance->shader=VuoShader_make("my_TimeDisplace Shader"); VuoShader_addSource(instance->shader,VuoMesh_IndividualTriangles,NULL,NULL,fragmentShaderSource); VuoRetain(instance->shader); return instance; }
